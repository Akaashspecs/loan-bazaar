...
function Partner() {
  ...
  const partner = [
    {
      desc: "I joined Loan Bazar 5 months ago. The app is very user friendly and the personalized website and marketing features helped me get more customers. The partner support team is very supportive and cooperative as well. All my queries have been resolved by them quickly. ",
      name: "Aakash Saxena",
      tag: "Loan Bazar Certified Partner",
      image: "/Aakash.png",
    },
    {
      desc: "I feel proud to be a Loan Bazar Partner. This job has earned me respect in society. Also I am very happy to help people when they are in financial difficulties. The appreciation that I get from my customers motivates me to always do my best.",
      name: "Sanjay Yadav",
      tag: "Loan Bazar Certified Partner",
      image: "/Sanjay.png",
    },
    {
      desc: "I am glad that I chose to associate myself with Loan Bazar. They have some unique financial products and selling those to people in need makes me very happy because through Loan Bazar I could make an impact in people’s lives. They have the best commissions in the market.",
  ...
  return (
    <div className="">
      ...
      <div className=" w-full bg-[#37445a] h-[96px]  text-center  justify-center items-center text-white text-sm sm:text-base md:text-xl lg:text-2xl gap-2 md:gap-5 flex flex-col md:flex-row  px-10">
        Are you looking to become a Loan Bazar Partner?
        <a
          href="/app-release.apk"
          className="px-6 bg-green-600 rounded-full py-1 md:py-2 text-base hover:scale-110 shadow-2xl transform duration-150 lg:hidden block"
        >
          Download App
        </a>
      ...
      <div className="pb-[80px] pt-[40px] px-[30px]">
        <div>
          <h3 className="text-[25px] md:text-[32px] font-medium  text-center text-[#1A2343]  ">
            Why is Loan Bazar the #1 trusted
      ...
      <div>
        <div className="py-[70px] bg-[#F8F8F8]">
          <div className="text-[25px] md:text-[32px] font-medium  text-center text-[#1A2343]  ">
            <h3>Who can earn with Loan Bazar?</h3>
          </div>
          <div className="h-[6px] w-[80px] bg-[#4eb543]  my-[15px] mx-auto "></div>
        </div>
      ...
      <div>
        <div className="pt-[70px] pb-[30px]  ">
          <h3 className="text-[25px] md:text-[32px] font-medium  text-center text-[#1A2343] ">
            What our Loan Bazar Partners say
          </h3>
          <div className="h-[6px] w-[80px] bg-[#4eb543]  my-[15px] mx-auto "></div>
        </div>
        ...
        <div className="my-30 flex justify-center">
          <div className="max-w-[700px] lg:max-w-[1600px] flex rounded-[50px] min-h-[310px]  md:h-[500px] lg:h-full w-full bg-[#37445a] px-10 2xl:px-24 pt-10 relative overflow-hidden  mx-5 md:mx-10">
            <div className="w-full text-center lg:text-start">
              ...
              <a
                href="/app-release.apk"
                className="lg:hidden block mx-auto lg:mx-0 mt-10 px-6 w-fit text-black bg-white rounded-full py-3 md:py-3 text-base hover:scale-110 shadow-2xl transform duration-150"
              >
                Download App
              </a>
            </div>
