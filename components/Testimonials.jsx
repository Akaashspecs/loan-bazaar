...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      date: "11 Dec 2019",
      message:
        "I applied for a personal loan on Loan Bazar. Manish Sharma was knowledgeable and efficient — great follow-ups and excellent communication. Highly recommended!",
    },
  ];
  return (
